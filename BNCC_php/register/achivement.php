...
<div class="form-control centre">
	...
	<table style="width: 80%">
			<tr>
				<th>Name of Achivement</th>
				<td><input class="form-control" type="text" name="Name_Of_Achievement"> <br></td>
			</tr>
			<tr>
				<th>BNCC No.:</th>
			...
			<tr>
				<th>Reason of achivement: </th>
				<td><input class="form-control" type="text" name="Reason_Of_Achievement"> <br></td>
			</tr>
			<tr>
				<th>Type of achivement: </th>
				<td><input class="form-control" type="text" name="Type_Of_Achievement"> <br></td>
			</tr>
			<tr>
				<th>Date of achivement: </th>
				<td><input class="form-control" type="text" name="Date_of_Achievement"> <br></td>
			</tr>
			<tr>
				<th>Place: </th>
