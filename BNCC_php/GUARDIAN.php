...
?>
 <p> Data inserted successfully <button type="button" class="btn btn-success"><a href="educational_info.php">Go to next Page</a></button> </p>
<?php
	}
	else {
?>
...
<div class="form-control centre">
	...
	<table style="width: 80%">
			...
			<tr>
				...
				<td><input class="form-control" type="text" name="G_ADDRESS"> <br></td>
			</tr>
			<tr>
				<th>Guardian NID : </th>
